          ...
          <div className="aboutme">
            <div className="aboutme__card">
              ...
              <div className="aboutme__share">
                <ul>
                  <li>
                    <a href={this.state.links[0]} target="_blank">
                      <GitHubComponent className="social-icons" />
                    </a>
                  </li>
                  <li>
                    <a href={this.state.links[1]} target="_blank">
                      <LinkedInComponent className="social-icons" />
                    </a>
                  </li>
                  <li>
                    <a href={this.state.links[2]} target="_blank">
                      <TwitterComponent className="social-icons" />
                    </a>
                  </li>
                  <li>
                    <a href={this.state.links[3]} target="_blank">
